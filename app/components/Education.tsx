  ...
  const education = [
    {
      ...
      achievements: [
        "Key Courses: Fundamental Programming Practices, Modern Programming Practices, Enterprise Applications, Web Application Architecture, Software Architecture, Web Application Programming",
      ],
    },
    {
      degree: "Bachelor of Science",
      institution: "Eritrean Institute of Technology",
      location: "Mai Nefhi, Eritrea",
      period: "Sept 2011 - June 2017",
      achievements: [
          ...
          {education.map((edu, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                {edu.location && <p className="text-xl text-gray-600 dark:text-gray-300 mb-4">{edu.location}</p>}
